...
<div class="row">
    ...
    <div class="${f:peek(stack, "_colPrefix")}3">
        <nav>
            <ul class="pager">
                <li class="previous {{previousEnabled()}}"><a href="#"><span aria-hidden="true">&larr;</span> Older</a></li>
                <li class="next {{nextEnabled()}}"><a href="#">Newer <span aria-hidden="true">&rarr;</span></a></li>
            </ul>
        </nav>
    </div>
</div>
