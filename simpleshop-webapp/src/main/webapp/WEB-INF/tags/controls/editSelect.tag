...
<jsp:useBean id="optionsBean" class="sponge.webapp.mvc.bean.SelectOptionBean" scope="request" />
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <select id="${id}" name="${path}" class="form-control" data-ng-model="${base}${path}" >
            ...
            <jsp:setProperty name="optionsBean" property="listName" value="${list}" />
            <jsp:getProperty name="optionsBean" property="options" />
