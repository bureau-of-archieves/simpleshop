...
public abstract class SupplierBaseController extends BaseJsonController {
    ...
    public String supplierSearch(@Valid @RequestBody final SupplierSearch supplierSearch, BindingResult bindingResult, Model model) {
    ...
    public String supplierSave(@Valid @RequestBody final Supplier supplier, BindingResult bindingResult, Model model) {
    ...
    public String supplierList(@Valid @RequestBody final ModelQuickSearch quickSearch, Model model){
